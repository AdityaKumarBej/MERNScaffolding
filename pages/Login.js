        ...
        return (
            <div style={{ height: '100%', width: '100%', display: 'flex', flexFlow: 'column' }}>
                <div className={styles.loginHeaderSection} >
                    <img src={`${UI_CONTEXT_ROOT}/logo.svg`} width="200px" />
                    <span className={styles.applicationName}>{appInfo.applicationName}</span>
                </div>
                <div className={styles.loginMidSection} style={{ backgroundImage: `url('${UI_CONTEXT_ROOT}/background2-min.jpg') ` }}>
                    {
                        (this.state.showEntitySelection) ?
                            <div className={styles.loginForm}>
                                <div className={styles.formItem}>
                                    <FormControl variant="outlined" style={{ minWidth: '350px', maxWidth: '350px' }}>
                                        <InputLabel style={{ backgroundColor: '#ffffff' }}>Please select entity to login as</InputLabel>
                                        <Select style={{ fontSize: '15px', width: '100%' }}
                                            id="entitySelector"
                                ...
                                <div className={styles.formItem}>
                                    <ButtonBase disabled={this.state.loggingIn} onClick={this.selectEntity} className={(this.state.loggingIn) ? styles.loginButton_disabled : styles.loginButton}>
                                        {
                            ...
                            <div className={styles.loginForm}>
                                ...
                                <div className={styles.formItem}>
                                    <input ref={this.password} type="password" placeholder="Password" onKeyPress={this.handleEnter} />
                                </div>
                                <div className={styles.formItem}>
                                    <ButtonBase disabled={this.state.loggingIn} onClick={this.execLogin} className={(this.state.loggingIn) ? styles.loginButton_disabled : styles.loginButton}>
                                        {
                                            (this.state.loggingIn) ?
                                                'Logging In ...'
                                                :
                                ...
                                <div className={styles.literature}>
                                    If you are a first time user and do not have a password. You need to have a profile created. To get a profile created, please reach out to dev.
                                </div>
                            </div>
                    }
                ...
                <div className={styles.loginFooterSection}>
                    <div>
                        ...
                        <div>
                            <a rel="noopener noreferrer" href="test" target="_blank">Privacy Statement</a>
                            &nbsp; | &nbsp;
                            <a rel="noopener noreferrer" href="test" target="_blank">Terms of Use &amp; Linking Policy</a>
                        </div>
                    </div>
                </div>
            </div>
